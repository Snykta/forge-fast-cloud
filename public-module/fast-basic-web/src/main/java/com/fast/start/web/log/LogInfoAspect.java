package com.fast.start.web.log;


import cn.hutool.core.util.ArrayUtil;
import cn.hutool.json.JSONUtil;
import com.fast.start.exception.ServiceException;
import com.fast.start.utils.FastObjUtil;
import com.fast.start.web.dto.LogInfoDto;
...
public class LogInfoAspect {
    ...
    public Object doAction(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        try {
            ...
            sbLog.append("\n\r|--错误信息:" + errorMsg + "\n\r" + getStackMsg(e));
            success = false;
            throw new ServiceException(errorMsg, e.getCause());
        } finally {
            stopWatch.stop();
    ...
    private static String getStackMsg(Exception e) {
        ...
        int length = Math.min(stackArray.length, 50);
