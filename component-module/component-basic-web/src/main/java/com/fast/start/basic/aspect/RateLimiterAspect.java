package com.fast.start.basic.aspect;

import com.fast.start.basic.annotation.RateLimiter;
import com.fast.start.basic.constant.BasicConstant;
import com.fast.start.basic.exception.ServiceException;
import com.fast.start.basic.utils.FastIpUtil;
...
public class RateLimiterAspect {
    ...
    @Pointcut("@annotation(com.fast.start.basic.annotation.RateLimiter)")
    ...
    public Object pointcut(ProceedingJoinPoint point) throws Throwable {
        ...
        if (rateLimiter != null) {
            ...
            String ipAddr = FastStrUtil.isEmpty(FastIpUtil.getIpAddr()) ? "无IP" : FastIpUtil.getIpAddr();
